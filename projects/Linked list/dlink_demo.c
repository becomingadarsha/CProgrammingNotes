/*
     ...
     This file is 43,668 bytes long and contains 1,673 lines.
...
int main( void )
{
     node_t *current, *new_node, *r1, *r2;
     int exit_program, last_num_used, menu, ret;

     /* Initialize important variables. */

     outfile = NULL;
     current = new_node = free_nodes = NULL;
...
void show_registers( node_t *r1, node_t *r2 )
{
     ...
     else
     {
          ...
          printf( "\nR1 points to a node at %08X", r1 );

#else  /* _64BITS */

          printf( "\nR1 points to a node at %016X", r1 );
     ...
     else
     {
          ...
          printf( "R2 points to a node at %08X", r2 );

#else  /* _64BITS */

          printf( "R2 points to a node at %016X", r2 );
